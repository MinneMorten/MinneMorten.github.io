...
function gotoMedia() { window.location.href = 'Media.html'; }
function gotoForum() { window.open('http://almost-harmless.com/'); }
function gotoApplication() { window.location.href = 'Application.html'; }
var menuSmallOpen = false;
function toggleMenuSmall() {
    if (menuSmallOpen) {
        $('#contentContainer').css('top', '0');
        $('#contentOverlay').css('display', 'none');
    } else {
        $('#contentOverlay').css('display', 'block');
        $('#contentContainer').css('top', '166px');
    }
    menuSmallOpen = !menuSmallOpen;
}
